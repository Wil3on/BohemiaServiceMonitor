  ...
  return (
    <div className="min-h-screen bg-gray-900 p-6 flex flex-col">
      ...
      <footer className="text-center text-gray-500 text-sm mt-8 pb-4">
        ...
        <p>ProjecX Arma Servers @ Discord: <a href="https://discord.gg/s4ZYfU3DUv" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">Arma BreakPoint</a></p>
      </footer>
    </div>
  );
}
